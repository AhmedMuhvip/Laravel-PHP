    ...
    <form method="POST" action="/jobs">
        ...
        <div class="space-y-12">
            <div class="border-b border-gray-900/10 pb-12">
                ...
                <p class="mt-1 text-sm/6 text-gray-600">W just need a handful of details from you. </p>
                        ...
                        <div class="mt-2">
                            <div
                                ...
                                <input type="text" name="salary" id="salary"
                                       class="block min-w-0 grow py-1.5 px-3 pr-3 text-base text-gray-900 placeholder:text-gray-400 focus:outline focus:outline-0 sm:text-sm/6"
                                       placeholder="$50,000,000 Year">
                            </div>
                            @error('salary')
                            <p class="text-xs text-red-500 font-semibold mt-4">{{$message}}</p>
                            @enderror
                        </div>
                    </div>
